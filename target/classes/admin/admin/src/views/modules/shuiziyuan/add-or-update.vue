    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="资源编号" prop="ziyuanbianhao">
            <el-input v-model="ruleForm.ziyuanbianhao" 
                placeholder="资源编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.ziyuanbianhao" label="资源编号" prop="ziyuanbianhao">
              <el-input v-model="ruleForm.ziyuanbianhao" 
                placeholder="资源编号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        ...
        <div v-else>
          <el-form-item class="input" label="资源分类" prop="ziyuanfenlei">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="储量（万立方米）" prop="chuliang">
          <el-input v-model="ruleForm.chuliang" 
              placeholder="储量（万立方米）" clearable  :readonly="ro.chuliang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="储量（万立方米）" prop="chuliang">
              <el-input v-model="ruleForm.chuliang" 
                placeholder="储量（万立方米）" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="分布地区" prop="fenbudiqu">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="分布地区"
                  v-model="ruleForm.fenbudiqu" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.fenbudiqu" label="分布地区" prop="fenbudiqu">
                    <span>{{ruleForm.fenbudiqu}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.fengmian = true;
          ...
          if(o=='chuliang'){
            this.ruleForm.chuliang = obj[o];
	    this.ro.chuliang = true;
            continue;
          }
          if(o=='fenbudiqu'){
            this.ruleForm.fenbudiqu = obj[o];
	    this.ro.fenbudiqu = true;
            continue;
          }
          if(o=='fabushijian'){
	...
	this.ruleForm.ziyuanxiangqing = this.ruleForm.ziyuanxiangqing.replace(reg,'../../../springboot60bhk/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `shuiziyuan/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.shuiziyuanCrossAddOrUpdateFlag = false;
						 this.parent.search();
